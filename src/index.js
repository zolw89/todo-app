...
submitProjectBtn.addEventListener("click", (e) => {
  ...
  if (ifExist(projectNameInput.value, todoList) === true)
    return alert("This project already exist");
...
submitTaskBtn.addEventListener("click", (e) => {
  ...
  const selectedProjectArr = todoList.find(
    (task) => task.category === selectedProject
  );
